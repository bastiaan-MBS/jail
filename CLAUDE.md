...
- Deploy: automatisch via GitHub Actions bij push naar `main` (FTP naar Vimexx)
...
## Team
- Peter Brouwers — Sales — peter@junioraileague.nl
- Bastiaan Arkenbout — Program — bastiaan@junioraileague.nl
- Geraldine Brouwers — Finance — geraldine@junioraileague.nl
...
│       ├── JAIL LOGO LIGGEND.svg     — Horizontaal logo voor witte achtergrond (footer-logo-bar)
...
- `JAIL LOGO LIGGEND.svg` — horizontaal logo, alleen op witte achtergrond (footer-logo-bar)
...
Gebruik altijd clean URLs (geen .html). Volgorde:
```html
<li><a href="/">Home</a></li>
